...
epistemic_if(temp > threshold, activate_cooler, activate_heater, policy=IfPolicy.strict)
# Output: (nothing)

# Fail-on-partial policy: raise exception
try:
    epistemic_if(temp > threshold, activate_cooler, activate_heater, policy=IfPolicy.panic)
